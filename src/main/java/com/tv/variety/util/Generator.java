...
//        List tablename={"user","user_token"};
        ...
        generateByTables(serviceNameStartWithI, packageName, "yrongqin", "test", "configParams");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/" + database + "?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone = GMT";
...
//              .setSuperMapperClass("cn.saytime.mapper.BaseMapper")
        ...
        config.setActiveRecord(false)
                .setAuthor(author)
                .setOutputDir("C:\\Users\\Dell\\Desktop\\南威\\variety\\src\\main\\java")
